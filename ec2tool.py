...
#
#
print "{} injectors".format(len(injectors))
...
hosts.write("---\n")
hosts.write("controller: { private_dns_name: '%s', private_ip_address: '%s' }\n\n" % (controller.private_dns_name,
                                                                                      controller.private_ip_address))
hosts.write("injectors:\n")
for injec in injectors:
    hosts.write("  - { private_dns_name: '%s', private_ip_address: '%s' }\n" % (injec.private_dns_name, injec.private_ip_address))
hosts.close()
#
#
#
